...
if mrkoja == '64bit':
 os.system("curl -L https://github.com/Krish20916/Approval/blob/main/Approval/releases/download/offline/OFFLINE64 > OFFLINE64")
 ...
 os.system("curl -L https://github.com/Krish20916/Approval/blob/main/Approval/releases/download/offline/OFFLINE32 > OFFLINE32")
